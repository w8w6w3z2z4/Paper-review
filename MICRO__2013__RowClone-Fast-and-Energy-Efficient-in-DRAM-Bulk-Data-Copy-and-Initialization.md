...
The key mechanism of RowClone is across internal channels (bitline or internal bus) instead of memory channels to accomplish bulk data operations. The RowClone contains two modes:
